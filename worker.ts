        ...
        if (path === '/api/quiz/active' && request.method === 'GET') {
            ...
            // Always sync default quizzes to ensure French translations are applied
            {
                ...
                const defaultQuizzes = [
                    ...
                    { id: 't4', type: 'QCM', question: 'Quel club berlinois est le plus célèbre au monde pour la Techno ?', options: ['Berghain', 'Tresor', 'Watergate', 'KitKat'], correctAnswer: 'Berghain', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 't7', type: 'QCM', question: 'Qui est surnommé le "Parrain de la Techno" ?', options: ['Juan Atkins', 'Kevin Saunderson', 'Derrick May', 'Jeff Mills'], correctAnswer: 'Juan Atkins', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 't9', type: 'QCM', question: 'De quel pays est originaire Amelie Lens ?', options: ['Belgique', 'France', 'Allemagne', 'Pays-Bas'], correctAnswer: 'Belgique', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    { id: 't10', type: 'QCM', question: 'Quel club historique a été fondé par Sven Väth ?', options: ['Cocoon', 'Omen', 'Pacha', 'Amnesia'], correctAnswer: 'Omen', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 't20', type: 'QCM', question: 'Quelle DJ Techno porte toujours un éventail ?', options: ['Indira Paganotto', 'Nina Kraviz', 'Deborah de Luca', 'Amelie Lens'], correctAnswer: 'Indira Paganotto', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 't23', type: 'QCM', question: 'Quel DJ est connu pour ses sets de + de 10h ?', options: ['Joseph Capriati', 'Ben Klock', 'Oscar Mulero', 'DVS1'], correctAnswer: 'Joseph Capriati', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    { id: 't24', type: 'QCM', question: 'Qui a produit la bande son du jeu Cyberpunk 2077 ?', options: ['Nina Kraviz', 'Paul Kalkbrenner', 'Grimes', 'Gesaffelstein'], correctAnswer: 'Nina Kraviz', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 't27', type: 'QCM', question: 'Quel sous-genre Techno a été inventé par Boris Brejcha ?', options: ['High-Tech Minimal', 'Melodic Techno', 'Business Techno', 'Hard Minimal'], correctAnswer: 'High-Tech Minimal', category: 'Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'bm8', type: 'QCM', question: 'D\'où est originaire le mouvement Drum \u0026 Bass ?', options: ['Royaume-Uni', 'USA', 'Jamaïque', 'Allemagne'], correctAnswer: 'Royaume-Uni', category: 'Bass', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'bm11', type: 'QCM', question: 'Quel est le nom du titre culte de Noisia ?', options: ['Stigma', 'Tommy\'s Theme', 'Dustup', 'Dead Limit'], correctAnswer: 'Dead Limit', category: 'Bass', author: 'Dropsiders', timestamp: now },
                    ...
                    // --- STUDIO \u0026 GEAR ---
                    { id: 'sg1', type: 'QCM', question: 'Quel DAW est le plus utilisé par les DJs EDM ?', options: ['Ableton Live', 'FL Studio', 'Logic Pro', 'Cubase'], correctAnswer: 'Ableton Live', category: 'Production', author: 'Dropsiders', timestamp: now },
                    { id: 'sg2', type: 'QCM', question: 'Quelle platine est le standard mondial en club ?', options: ['Pioneer CDJ-3000', 'Denon SC6000', 'Technics SL-1200', 'Traktor S4'], correctAnswer: 'Pioneer CDJ-3000', category: 'Gear', author: 'Dropsiders', timestamp: now },
                    { id: 'sg3', type: 'QCM', question: 'Quel synthétiseur a défini le son "Acid House" ?', options: ['Roland TB-303', 'Roland TR-808', 'Korg MS-20', 'Moog One'], correctAnswer: 'Roland TB-303', category: 'Gear', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'sg6', type: 'QCM', question: 'Quelle boîte à rythmes est célèbre pour son kick iconique ?', options: ['Roland TR-808', 'Roland TR-909', 'LinnDrum', 'MPC 2000'], correctAnswer: 'Roland TR-909', category: 'Gear', author: 'Dropsiders', timestamp: now },
                    { id: 'sg7', type: 'QCM', question: 'Quel effet permet de réduire la dynamique d\'un son ?', options: ['Compresseur', 'Reverb', 'Delay', 'Chorus'], correctAnswer: 'Compresseur', category: 'Production', author: 'Dropsiders', timestamp: now },
                    { id: 'sg8', type: 'QCM', question: 'Quel est le taux d\'échantillonnage standard d\'un CD Audio ?', options: ['44.1 kHz', '48 kHz', '96 kHz', '192 kHz'], correctAnswer: '44.1 kHz', category: 'Production', author: 'Dropsiders', timestamp: now },
                    { id: 'sg9', type: 'QCM', question: 'Quel plugin est devenu le standard pour la synthèse "Wavetable" ?', options: ['Serum', 'Phase Plant', 'Vital', 'Avenger'], correctAnswer: 'Serum', category: 'Production', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'sg11', type: 'QCM', question: 'Quel casque est le favori des DJs pro pour sa robustesse ?', options: ['Sennheiser HD-25', 'Audio-Technica M50x', 'V-Moda Crossfade', 'Beats Pro'], correctAnswer: 'Sennheiser HD-25', category: 'Gear', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'sg13', type: 'QCM', question: 'Quelle mixeur est la plus répandue en club ?', options: ['Pioneer DJM-900NXS2', 'Allen \u0026 Heath Xone:92', 'Rane Seventy', 'V10'], correctAnswer: 'Pioneer DJM-900NXS2', category: 'Gear', author: 'Dropsiders', timestamp: now },
                    { id: 'sg14', type: 'QCM', question: 'Quel logiciel est utilisé pour préparer ses tracks (Pioneer) ?', options: ['Rekordbox', 'Serato', 'Traktor', 'Engine DJ'], correctAnswer: 'Rekordbox', category: 'Logiciel', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'sg16', type: 'QCM', question: 'Quel plugin permet de corriger la justesse d\'une voix ?', options: ['Auto-Tune', 'Melodyne', 'Vocodex', 'Les deux'], correctAnswer: 'Les deux', category: 'Production', author: 'Dropsiders', timestamp: now },
                    { id: 'sg17', type: 'QCM', question: 'Quel type d\'onde est la plus riche en harmoniques ?', options: ['Carrée', 'Dents de scie', 'Sinusoïdale', 'Triangle'], correctAnswer: 'Dents de scie', category: 'Synthèse', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'sg19', type: 'QCM', question: 'Quel est l\'instrument phare du groupe Kraftwerk ?', options: ['Synthétiseur', 'Guitare', 'Batterie', 'Violon'], correctAnswer: 'Synthétiseur', category: 'Histoire', author: 'Dropsiders', timestamp: now },
                    { id: 'sg20', type: 'QCM', question: 'Quel est le terme pour caler deux tracks au même tempo ?', options: ['Beatmatching', 'Crossfading', 'Syncing', 'Phasing'], correctAnswer: 'Beatmatching', category: 'DJing', author: 'Dropsiders', timestamp: now },

                    // --- LEGENDS \u0026 CLASSICS ---
                    { id: 'lc1', type: 'QCM', question: 'Qui a produit le titre "Born Slippy" ?', options: ['Underworld', 'Faithless', 'The Chemical Brothers', 'The Prodigy'], correctAnswer: 'Underworld', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc2', type: 'QCM', question: 'Quel titre de Faithless est un hymne absolu ?', options: ['Insomnia', 'God is a DJ', 'We Come 1', 'Salva Mea'], correctAnswer: 'Insomnia', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc3', type: 'QCM', question: 'Qui a produit "Music Sounds Better With You" ?', options: ['Stardust', 'Daft Punk', 'Cassius', 'Modjo'], correctAnswer: 'Stardust', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc4', type: 'QCM', question: 'Quel groupe est l\'auteur de "Firestarter" ?', options: ['The Prodigy', 'The Chemical Brothers', 'Fatboy Slim', 'Orbital'], correctAnswer: 'The Prodigy', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc5', type: 'QCM', question: 'Qui est l\'auteur de "Praise You" ?', options: ['Fatboy Slim', 'Moby', 'Norman Cook', 'Les deux'], correctAnswer: 'Les deux', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc6', type: 'QCM', question: 'Quel titre de Moby a été utilisé dans de nombreux films ?', options: ['Porcelain', 'Go', 'Extreme Ways', 'Natural Blues'], correctAnswer: 'Porcelain', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc7', type: 'QCM', question: 'Qui a produit "Blue Monday" ?', options: ['New Order', 'Depeche Mode', 'The Cure', 'Pet Shop Boys'], correctAnswer: 'New Order', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc8', type: 'QCM', question: 'Quel groupe a popularisé le son "Detroit Techno" ?', options: ['The Belleville Three', 'Cybotron', 'Model 500', 'Tous ceux-là'], correctAnswer: 'Tous ceux-là', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc9', type: 'QCM', question: 'Qui a produit "Hey Boy Hey Girl" ?', options: ['The Chemical Brothers', 'The Crystal Method', 'The Propellerheads', 'Fatboy Slim'], correctAnswer: 'The Chemical Brothers', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc10', type: 'QCM', question: 'Quel est le hit le plus connu d\'Alice Deejay ?', options: ['Better Off Alone', 'Back In My Life', 'Will I Ever', 'The Lonely One'], correctAnswer: 'Better Off Alone', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc11', type: 'QCM', question: 'Qui a produit "Missing" (Todd Terry Remix) ?', options: ['Everything But The Girl', 'Moloko', 'Olive', 'Sneaker Pimps'], correctAnswer: 'Everything But The Girl', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc12', type: 'QCM', question: 'Quel titre est une collab entre Avicii et Aloe Blacc ?', options: ['Wake Me Up', 'S.O.S', 'Liar Liar', 'Tous ceux-là'], correctAnswer: 'Tous ceux-là', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc13', type: 'QCM', question: 'Qui a produit "Sandstorm" ?', options: ['Darude', 'Zombie Nation', 'Safri Duo', 'Tiësto'], correctAnswer: 'Darude', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc14', type: 'QCM', question: 'Quel titre de Kernkraft 400 est un classique des stades ?', options: ['Zombie Nation', 'Sandstorm', 'The Launch', 'Blade'], correctAnswer: 'Zombie Nation', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc15', type: 'QCM', question: 'Qui a produit "Lady (Hear Me Tonight)" ?', options: ['Modjo', 'Bob Sinclar', 'Cassius', 'Daft Punk'], correctAnswer: 'Modjo', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc16', type: 'QCM', question: 'Quel est le tube techno de Laurent Garnier ?', options: ['Crispy Bacon', 'The Man With The Red Face', 'Communications', 'The Sound of the Big Babou'], correctAnswer: 'The Man With The Red Face', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc17', type: 'QCM', question: 'Qui a produit "God is a DJ" ?', options: ['Faithless', 'Massive Attack', 'Leftfield', 'Underworld'], correctAnswer: 'Faithless', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc18', type: 'QCM', question: 'Quel est le titre culte de Benny Benassi ?', options: ['Satisfaction', 'Able to Love', 'Illusion', 'Cinema'], correctAnswer: 'Satisfaction', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc19', type: 'QCM', question: 'Qui a produit "Seven Nation Army" (EDM Remix) ?', options: ['The White Stripes', 'Benny Benassi', 'Glitch Mob', 'Hardwell'], correctAnswer: 'Glitch Mob', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc20', type: 'QCM', question: 'Quel titre d\'Eric Prydz utilise un sample de Steve Winwood ?', options: ['Call On Me', 'Pjanoo', 'Proper Education', 'Generations'], correctAnswer: 'Call On Me', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc21', type: 'QCM', question: 'Qui est l\'auteur de "Smack My Bitch Up" ?', options: ['The Prodigy', 'The Chemical Brothers', 'Fatboy Slim', 'Orbital'], correctAnswer: 'The Prodigy', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc22', type: 'QCM', question: 'Quel est le gros hit de Gala ?', options: ['Freed From Desire', 'Let A Boy Cry', 'Come Into My Life', 'Suddenly'], correctAnswer: 'Freed From Desire', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc23', type: 'QCM', question: 'Qui a produit "Silence" (Tiesto Remix) ?', options: ['Delerium', 'Sarah McLachlan', 'Conjure One', 'Les deux premiers'], correctAnswer: 'Les deux premiers', category: 'Classiques', author: 'Trance', timestamp: now },
                    { id: 'lc24', type: 'QCM', question: 'Qui est l\'auteur de "Pump Up The Jam" ?', options: ['Technotronic', 'Snap!', '2 Unlimited', 'C\u0026C Music Factory'], correctAnswer: 'Technotronic', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc25', type: 'QCM', question: 'Quel est le tube de Robert Miles ?', options: ['Children', 'Fable', 'One \u0026 One', 'Freedom'], correctAnswer: 'Children', category: 'Trance', author: 'Dropsiders', timestamp: now },
                    { id: 'lc26', type: 'QCM', question: 'Qui a produit "Believe" ?', options: ['Cher', 'The Chemical Brothers', 'Sunblind', 'Paul van Dyk'], correctAnswer: 'Cher', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc27', type: 'QCM', question: 'Quel est le titre le plus connu de Darude ?', options: ['Sandstorm', 'Feel The Beat', 'Out of Control', 'Music'], correctAnswer: 'Sandstorm', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc28', type: 'QCM', question: 'Qui a produit "Rhythm is a Dancer" ?', options: ['Snap!', 'Technotronic', 'Corona', 'Culture Beat'], correctAnswer: 'Snap!', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc29', type: 'QCM', question: 'Quel est le nom du hit de Haddaway ?', options: ['What is Love', 'Life', 'Rock My Heart', 'Fly Away'], correctAnswer: 'What is Love', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    { id: 'lc30', type: 'QCM', question: 'Quel groupe est derrière "The Launch" ?', options: ['DJ Jean', 'DJ Quicksilver', 'Mauro Picotto', 'Alice Deejay'], correctAnswer: 'DJ Jean', category: 'Classiques', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'mt3', type: 'QCM', question: 'Qui a produit "The Age of Love" (Afterlife Remix) ?', options: ['Maceo Plex', 'ARTBAT', 'Charlotte de Witte', 'Mathame'], correctAnswer: 'ARTBAT', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    { id: 'mt4', type: 'QCM', question: 'Quel est le vrai nom d\'Anyma ?', options: ['Matteo Milleri', 'Carmine Conte', 'Solomun', 'Adriatique'], correctAnswer: 'Matteo Milleri', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    { id: 'mt5', type: 'QCM', question: 'De quel pays est originaire le duo ARTBAT ?', options: ['Ukraine', 'Russie', 'Allemagne', 'Italie'], correctAnswer: 'Ukraine', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'mt8', type: 'QCM', question: 'Quel festival est connu pour les visuels 3D d\'Anyma ?', options: ['Afterlife', 'Tomorrowland', 'Ultra', 'Awakenings'], correctAnswer: 'Afterlife', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    { id: 'mt9', type: 'QCM', question: 'Quel duo est composé d\'Adrian Shala et Adrian Schweizer ?', options: ['Adriatique', 'Tale Of Us', 'Bedouin', 'Camelphat'], correctAnswer: 'Adriatique', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'mt13', type: 'QCM', question: 'Quel DJ est connu pour ses sets en haut des montagnes (Cercle) ?', options: ['Ben Böhmer', 'Boris Brejcha', 'Monolink', 'Tous ceux-là'], correctAnswer: 'Tous ceux-là', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'mt20', type: 'QCM', question: 'De quel pays est originaire Ben Böhmer ?', options: ['Allemagne', 'France', 'Suisse', 'Autriche'], correctAnswer: 'Allemagne', category: 'Melodic Techno', author: 'Dropsiders', timestamp: now },
                    ...
                    // --- DEEP HOUSE (EN) ---
                    { id: 'dhen1', type: 'QCM', question: 'Qui est l\'auteur de "Coffee" ?', options: ['Black Coffee', 'Themba', 'Shimza', 'Culoe De Song'], correctAnswer: 'Black Coffee', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen2', type: 'QCM', question: 'Quel label appartient à Bedouin ?', options: ['Human By Default', 'Crosstown Rebels', 'All Day I Dream', 'Innervisions'], correctAnswer: 'Human By Default', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen3', type: 'QCM', question: 'Qui a produit "Walking On A Dream" (Remix) ?', options: ['Sacha Braemer', 'Monkey Safari', 'Nora En Pure', 'Purple Disco Machine'], correctAnswer: 'Sacha Braemer', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen4', type: 'QCM', question: 'Quel est le nom du hit de Keinemusik ?', options: ['The Rapture Pt.III', 'Muye', 'Forms of Love', 'Les Gout'], correctAnswer: 'The Rapture Pt.III', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen5', type: 'QCM', question: 'Quel duo est derrière Keinemusik ?', options: ['&ME & Rampa', 'Adam Port & Reznik', 'Les deux', 'Solomun & Dixon'], correctAnswer: 'Les deux', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen6', type: 'QCM', question: 'Qui a produit "You & Me" (Remix) ?', options: ['Flume', 'Disclosure', 'MEUTE', 'Rivo'], correctAnswer: 'Flume', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen7', type: 'QCM', question: 'Quel label appartient à Maya Jane Coles ?', options: ['I/AM/ME', 'Hypercolour', 'Defected', 'Toolroom'], correctAnswer: 'I/AM/ME', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen8', type: 'QCM', question: 'Qui a produit "Epikur" ?', options: ['David August', 'Nicolas Jaar', 'Kolektiv Turmstrasse', 'Christian Löffler'], correctAnswer: 'David August', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen9', type: 'QCM', question: 'Quel groupe est connu pour ses reprises techno en fanfare ?', options: ['MEUTE', 'Black Coffee', 'WhoMadeWho', 'GHEIST'], correctAnswer: 'MEUTE', category: 'Deep House', author: 'Dropsiders', timestamp: now },
                    { id: 'dhen10', type: 'QCM', question: 'Qui a produit l\'album "Pink" ?', options: ['Four Tet', 'Bonobo', 'Caribou', 'Floating Points'], correctAnswer: 'Four Tet', category: 'Deep House', author: 'Dropsiders', timestamp: now },

                    // --- BASS HOUSE ---
                    { id: 'bh1', type: 'QCM', question: 'Qui est surnommé le "King of Bass House" ?', options: ['Joyryde', 'Habstrakt', 'Jauz', 'AC Slater'], correctAnswer: 'Joyryde', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh2', type: 'QCM', question: 'Quel DJ français est un pilier de la Bass House ?', options: ['Habstrakt', 'Malaa', 'Tchami', 'Tony Romera'], correctAnswer: 'Habstrakt', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh3', type: 'QCM', question: 'Quel est le label d\'AC Slater ?', options: ['Night Bass', 'Confession', 'Sable Valley', 'Owsla'], correctAnswer: 'Night Bass', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh4', type: 'QCM', question: 'Qui a produit "Losing It" ?', options: ['Fisher', 'Chris Lake', 'Anti Up', 'Dom Dolla'], correctAnswer: 'Fisher', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh5', type: 'QCM', question: 'Quel label a été fondé par Tchami ?', options: ['Confession', 'Pardon My French', 'Hexagon', 'Musical Freedom'], correctAnswer: 'Confession', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh6', type: 'QCM', question: 'Quel DJ mystérieux est souvent associé à Tchami ?', options: ['Malaa', 'Dillon Francis', 'Mercer', 'DJ Snake'], correctAnswer: 'Malaa', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh7', type: 'QCM', question: 'Qui a produit "Damn" ?', options: ['Joyryde', 'Skrillex', 'Eptic', 'Must Die'], correctAnswer: 'Joyryde', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh8', type: 'QCM', question: 'Quel duo est composé de Chris Lake et Chris Lorenzo ?', options: ['Anti Up', 'Noizu', 'Eli Brown', 'Walker \u0026 Royce'], correctAnswer: 'Anti Up', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh9', type: 'QCM', question: 'Qui est l\'auteur de "Chicken Soup" ?', options: ['Habstrakt \u0026 Skrillex', 'Joyryde', 'Jauz', 'Curbi'], correctAnswer: 'Habstrakt \u0026 Skrillex', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'bh10', type: 'QCM', question: 'Quel est le slogan le plus célèbre de Jauz ?', options: ['Feel The Volume', 'Shark Attack', 'Bite This', 'Deep With Us'], correctAnswer: 'Bite This', category: 'Bass House', author: 'Dropsiders', timestamp: now },

                    // --- TRAP \u0026 FUTURE BASS ---
                    { id: 'tfb1', type: 'QCM', question: 'Qui est l\'auteur de "Harlem Shake" ?', options: ['Baauer', 'RL Grime', 'Flosstradamus', 'Yellow Claw'], correctAnswer: 'Baauer', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb2', type: 'QCM', question: 'Quel est le label de RL Grime ?', options: ['Sable Valley', 'Wakaan', 'Deadbeats', 'Bitbird'], correctAnswer: 'Sable Valley', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb3', type: 'QCM', question: 'Qui a produit l\'album "Hi This Is Flume" ?', options: ['Flume', 'Quiet Bison', 'Kučka', 'What So Not'], correctAnswer: 'Flume', category: 'Future Bass', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb4', type: 'QCM', question: 'Quel duo est derrière le hit "Prison Riot" ?', options: ['Flosstradamus \u0026 GTA', 'Yellow Claw', 'Jack Ü', 'Major Lazer'], correctAnswer: 'Flosstradamus \u0026 GTA', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb5', type: 'QCM', question: 'Qui a produit "Be Together" ?', options: ['Major Lazer', 'DJ Snake', 'Marshmello', 'San Holo'], correctAnswer: 'Major Lazer', category: 'Future Bass', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb6', type: 'QCM', question: 'Quel est le label de San Holo ?', options: ['Bitbird', 'Monstercat', 'STMPD', 'Moving Castle'], correctAnswer: 'Bitbird', category: 'Future Bass', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb7', type: 'QCM', question: 'Qui a produit "Turn Down For What" ?', options: ['DJ Snake \u0026 Lil Jon', 'Diplo', 'TNGHT', 'Hudson Mohawke'], correctAnswer: 'DJ Snake \u0026 Lil Jon', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb8', type: 'QCM', question: 'Quel duo est composé de Hudson Mohawke et Lunice ?', options: ['TNGHT', 'Jack Ü', 'Dog Blood', 'Duck Sauce'], correctAnswer: 'TNGHT', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb9', type: 'QCM', question: 'Qui a produit "Higher Ground" ?', options: ['TNGHT', 'RL Grime', 'Baauer', 'Hucci'], correctAnswer: 'TNGHT', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    { id: 'tfb10', type: 'QCM', question: 'Quel DJ est célèbre pour son "Halloween Mix" chaque année ?', options: ['RL Grime', 'Baauer', 'Alison Wonderland', 'NGHTMRE'], correctAnswer: 'RL Grime', category: 'Trap', author: 'Dropsiders', timestamp: now },
                    ...
                    { id: 'hfc1', type: 'QCM', question: 'Qui est l\'auteur de "Trip To Ireland" ?', options: ['Dr. Peacock', 'Sefa', 'Billx', 'The Sickest Squad'], correctAnswer: 'Dr. Peacock', category: 'Frenchcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc2', type: 'QCM', question: 'Quel groupe est derrière le hit "Ready To Die" ?', options: ['Angerfist', 'Miss K8', 'Mad Dog', 'Anime'], correctAnswer: 'Angerfist', category: 'Hardcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc3', type: 'QCM', question: 'Qui a produit l\'album "Klaar" ?', options: ['Sefa', 'Dr. Peacock', 'Billx', 'Floxytek'], correctAnswer: 'Sefa', category: 'Frenchcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc4', type: 'QCM', question: 'Quel est le plus grand festival Hard Music au monde ?', options: ['Defqon.1', 'Dominator', 'Masters of Hardcore', 'Decibel'], correctAnswer: 'Defqon.1', category: 'Hard Music', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc5', type: 'QCM', question: 'Quel DJ est surnommé "The King of Hardcore" ?', options: ['Angerfist', 'Mad Dog', 'Tha Playah', 'Nosferatu'], correctAnswer: 'Angerfist', category: 'Hardcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc6', type: 'QCM', question: 'Qui est l\'auteur de "Na Na Na" ?', options: ['Billx', 'Floxytek', 'Vandal', 'Mat Weasel'], correctAnswer: 'Billx', category: 'Frenchcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc7', type: 'QCM', question: 'Quel sous-genre est caractérisé par ses kicks "Psy" et un tempo rapide ?', options: ['Hard-Psy', 'Frenchcore', 'Rawstyle', 'Uptempo'], correctAnswer: 'Hard-Psy', category: 'Hard Music', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc8', type: 'QCM', question: 'Qui a produit "The Edge of Existence" ?', options: ['Sefa \u0026 Phuture Noize', 'Dr. Peacock', 'Angerfist', 'Billx'], correctAnswer: 'Sefa \u0026 Phuture Noize', category: 'Frenchcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc9', type: 'QCM', question: 'Quelle ville est le cœur du mouvement Gabber ?', options: ['Rotterdam', 'Amsterdam', 'Paris', 'Berlin'], correctAnswer: 'Rotterdam', category: 'Hardcore', author: 'Dropsiders', timestamp: now },
                    { id: 'hfc10', type: 'QCM', question: 'Quel DJ porte toujours un masque de hockey ?', options: ['Angerfist', 'Malaa', 'Marshmello', 'Deadmau5'], correctAnswer: 'Angerfist', category: 'Hardcore', author: 'Dropsiders', timestamp: now },

                    // --- NOUVELLE BIG ROOM / FESTIVALS ---
                    { id: 'nbr1', type: 'QCM', question: 'Quel producteur a relancé la Big Room avec "Rave Culture" ?', options: ['W\u0026W', 'Hardwell', 'Blasterjaxx', 'Timmy Trumpet'], correctAnswer: 'W\u0026W', category: 'Big Room', author: 'Dropsiders', timestamp: now },
                    { id: 'nbr2', type: 'QCM', question: 'Qui a produit "I\'m Good (Blue)" ?', options: ['David Guetta \u0026 Bebe Rexha', 'Tiesto', 'Calvin Harris', 'Alesso'], correctAnswer: 'David Guetta \u0026 Bebe Rexha', category: 'EDM', author: 'Dropsiders', timestamp: now },
                    { id: 'nbr3', type: 'QCM', question: 'Quel festival a lieu sur un bateau en Méditerranée ?', options: ['The Ark', 'Holy Ship', 'It\'s The Ship', 'Cruise'], correctAnswer: 'The Ark', category: 'Festivals', author: 'Dropsiders', timestamp: now },
                    { id: 'nbr4', type: 'QCM', question: 'Qui est l\'auteur de "The Motto" ?', options: ['Tiesto \u0026 Ava Max', 'David Guetta', 'Joel Corry', 'Jax Jones'], correctAnswer: 'Tiesto \u0026 Ava Max', category: 'EDM', author: 'Dropsiders', timestamp: now },
                    { id: 'nbr5', type: 'QCM', question: 'Quel DJ est connu pour ses sets avec trompette en live ?', options: ['Timmy Trumpet', 'Salvatore Ganacci', 'Steve Aoki', 'Fisher'], correctAnswer: 'Timmy Trumpet', category: 'EDM', author: 'Dropsiders', timestamp: now },

                    // --- NEW TECHNO / HOUSE ---
                    { id: 'nth1', type: 'QCM', question: 'Qui a produit l\'édit viral de "Gimme! Gimme! Gimme!" ?', options: ['Sash!', 'Mau P', 'James Hype', 'John Summit'], correctAnswer: 'Mau P', category: 'House', author: 'Dropsiders', timestamp: now },
                    { id: 'nth2', type: 'QCM', question: 'Quel titre de James Hype est un hit mondial ?', options: ['Ferrari', 'Drums', 'Say Yeah', 'Disconnected'], correctAnswer: 'Ferrari', category: 'House', author: 'Dropsiders', timestamp: now },
                    { id: 'nth3', type: 'QCM', question: 'Qui a produit "Drugs From Amsterdam" ?', options: ['Mau P', 'Chris Lake', 'Fisher', 'Mochakk'], correctAnswer: 'Mau P', category: 'Tech House', author: 'Dropsiders', timestamp: now },
                    { id: 'nth4', type: 'QCM', question: 'Quel DJ est connu pour sa maîtrise du mix sur 4 platines ?', options: ['James Hype', 'Carl Cox', 'Solomun', 'Vintage Culture'], correctAnswer: 'James Hype', category: 'Tech House', author: 'Dropsiders', timestamp: now },
                    { id: 'nth5', type: 'QCM', question: 'Qui a produit "Where You Are" ?', options: ['John Summit \u0026 Hayla', 'Dom Dolla', 'Eli Brown', 'Anyma'], correctAnswer: 'John Summit \u0026 Hayla', category: 'House', author: 'Dropsiders', timestamp: now },

                    // --- NEW BASS / D\u0026B ---
                    { id: 'nba1', type: 'QCM', question: 'Qui a produit "Baddadan" ?', options: ['Chase \u0026 Status', 'Sub Focus', 'Bou', 'Hedex'], correctAnswer: 'Chase \u0026 Status', category: 'D\u0026B', author: 'Dropsiders', timestamp: now },
                    { id: 'nba2', type: 'QCM', question: 'Quel sous-genre D\u0026B explose avec Bou ?', options: ['Jump Up', 'Liquid', 'Neurofunk', 'Jungle'], correctAnswer: 'Jump Up', category: 'D\u0026B', author: 'Dropsiders', timestamp: now },
                    { id: 'nba3', type: 'QCM', question: 'Qui a produit "Rhyme Dust" ?', options: ['MK \u0026 Dom Dolla', 'Bou', 'Hedex', 'Turno'], correctAnswer: 'MK \u0026 Dom Dolla', category: 'Bass House', author: 'Dropsiders', timestamp: now },
                    { id: 'nba4', type: 'QCM', question: 'Qui a produit "Liquor \u0026 Cigarettes" ?', options: ['Chase \u0026 Status \u0026 Hedex', 'Sub Focus', 'Dimension', 'Kanine'], correctAnswer: 'Chase \u0026 Status \u0026 Hedex', category: 'D\u0026B', author: 'Dropsiders', timestamp: now },
