...
async function run() {
    ...
    for (let i = 0; i < djs.length; i++) {
        ...
        results.push({
            ...
            bio: `Artiste de renommée internationale, classé dans le Top 100 DJ Mag ou Top 101 Producers (1001Tracklists). Ses sets enflamment les scènes des plus grands festivals mondiaux.`,
            country: 'Intl',
            image: imageUrl,
