...
export type TranslationKey =
    | 'nav.news' | 'nav.recaps' | 'nav.communaute' | 'nav.voyage' | 'nav.vols' | 'nav.bus' | 'nav.interviews' | 'nav.agenda' | 'nav.team' | 'nav.shop' | 'nav.contact' | 'nav.galerie' | 'nav.top_dropsiders'
...
export const translations: Record<TranslationKey, { fr: string, en: string }> = {
    ...
    'nav.top_dropsiders': { fr: 'TOP DROPSIDERS', en: 'TOP DROPSIDERS' },
    ...
    'wiki_djs_title': { fr: 'DJs', en: 'DJs' },
    'wiki_clubs_title': { fr: 'Clubs', en: 'Clubs' },
    'wiki_festivals_title': { fr: 'Festivals', en: 'Festivals' },
