                        ...
                        <Link to={getRecapLink(item)} key={item.id} className="block group">
                            ...
                            >
                                ...
                                <div className="absolute bottom-0 left-0 right-0 p-3 bg-gradient-to-t from-black/90 via-black/40 to-transparent">
                                    <h4 className="text-[17px] font-display font-bold text-white leading-tight group-hover:text-neon-orange transition-colors line-clamp-2 uppercase italic tracking-tight">{item.title}</h4>
