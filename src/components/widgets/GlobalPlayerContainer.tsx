        ...
        <AnimatePresence>
            ...
            >
                <div className="max-w-7xl mx-auto pointer-events-auto shadow-[0_-20px_60px_rgba(0,0,0,0.8)] rounded-[40px]">
                    {/* Minimized Bar */}
                    <div className={`bg-black/80 backdrop-blur-2xl border border-white/10 rounded-3xl p-4 flex items-center justify-between shadow-[0_10px_40px_rgba(0,0,0,0.5)] ${isMinimized ? 'flex' : 'hidden'}`}>
                    ...
                    {/* Maximized Player (Kept in DOM so audio doesn't stop) */}
