...
export function Footer() {
    ...
    const socialLinks = [
        { name: 'Instagram', icon: <img src="https://cdn-icons-png.flaticon.com/512/2111/2111463.png" alt="Instagram" className="w-6 h-6 object-contain filter group-hover:brightness-0 group-hover:invert-[0.20] group-hover:sepia-[0.95] group-hover:saturate-[6000%] group-hover:hue-rotate-[350deg]" />, href: `https://instagram.com/${(socials.instagram || 'dropsiders.fr').replace('@', '')}`, color: 'group-hover:border-neon-red group-hover:bg-neon-red/10' },
        { name: 'TikTok', icon: <img src="https://cdn-icons-png.flaticon.com/512/3046/3046121.png" alt="TikTok" className="w-6 h-6 object-contain filter group-hover:brightness-0 group-hover:invert-[0.20] group-hover:sepia-[0.95] group-hover:saturate-[6000%] group-hover:hue-rotate-[350deg]" />, href: `https://tiktok.com/@${(socials.tiktok || 'dropsiders.fr').replace('@', '')}`, color: 'group-hover:border-neon-red group-hover:bg-neon-red/10' },
