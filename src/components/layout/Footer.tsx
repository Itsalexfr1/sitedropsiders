...
export function Footer() {
    ...
    const socialLinks = [
        ...
        { name: 'Facebook', icon: <img src="https://cdn-icons-png.flaticon.com/512/733/733547.png" alt="Facebook" className="w-6 h-6 object-contain filter group-hover:brightness-0 group-hover:invert-[0.20] group-hover:sepia-[0.95] group-hover:saturate-[6000%] group-hover:hue-rotate-[350deg]" />, href: `https://www.facebook.com/dropsiders.eu`, color: 'group-hover:border-neon-red group-hover:bg-neon-red/10' }
    ];
