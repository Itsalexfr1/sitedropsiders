                            ...
                            {isLoggedIn ? (
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <button
                                            className="flex items-center justify-center gap-3 py-4 bg-white/5 border border-white/10 rounded-2xl hover:bg-[#5865F2] hover:border-[#5865F2] transition-all group"
                                        >
