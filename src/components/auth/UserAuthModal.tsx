...
export function UserAuthModal({ isOpen, onClose }: UserAuthModalProps) {
    ...
    // Authentification Google via redirection OAuth universelle (sécurisée)
    // Nous bypassons totalement les SDK iframe de Google car les bloqueurs de cookies (Safari ITP, Brave, Incognito) 
    // provoquent un plantage et un faux rechargement de la page.
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <button
                                            ...
                                            className="w-full h-14 rounded-2xl flex items-center justify-center gap-3 bg-white/5 hover:bg-white/10 border border-white/10 transition-all text-white font-medium"
                                        >
                                            {isSocialLoading ? <Loader2 className="w-5 h-5 animate-spin text-white" /> : (
                                                <>
                                                    ...
                                                    <span className="text-[10px] font-black uppercase tracking-widest mt-0.5">Google</span>
                                                </>
                                            )}
                                        </button>
                                        <button
