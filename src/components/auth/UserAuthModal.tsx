...
export function UserAuthModal({ isOpen, onClose }: UserAuthModalProps) {
    ...
    // Desktop utilise le composant GoogleLogin 
    // Mobile utilise une redirection vers OAuth pour contourner l'anti-tracking ITP (Safari) et popup blockers
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div className="flex items-center justify-center overflow-hidden rounded-2xl bg-black relative">
                                            <div className="w-full flex justify-center py-1">
                                                {/* Le bouton officiel masque l'erreur anti-clickjacking */}
                                                ...
                                                <div className="block md:hidden w-full h-full">
                                                    <button
                                                        ...
                                                        className="w-full h-[40px] flex items-center justify-center gap-3 bg-black hover:bg-white/5 transition-all text-white font-medium text-[14px]"
                                                    >
