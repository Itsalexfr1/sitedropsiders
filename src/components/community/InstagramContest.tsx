            ...
            >
                ...
                <div className="relative z-10 space-y-8">
                    ...
                    <p className="text-sm md:text-lg font-medium opacity-80 max-w-2xl leading-relaxed">
                        Partagez votre score du Quiz en story, taguez <span className="font-black">@dropsiders.fr</span> {festivalHandle && <>ainsi que <span className="font-black text-white">{festivalHandle}</span></>} pour valider votre participation.
                    </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
                ...
                <div className="md:col-span-5 space-y-4">
                    {[
                        ...
                        { num: '03', title: 'TAGUEZ', desc: `Identifiez @dropsiders.fr ${festivalHandle ? 'et ' + festivalHandle : ''} sur votre story (votre compte doit être PUBLIC).` },
