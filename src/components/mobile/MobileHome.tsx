                    ...
                    {featuredNews.map((news) => (
                        ...
                        >
                            ...
                            <div className="absolute bottom-0 left-0 right-0 p-3 md:p-4">
                                ...
                                <h3 className="text-[3px] md:text-[11px] font-display font-black text-white italic leading-tight uppercase line-clamp-3">
                                    {news.title}
                                </h3>
                            </div>
                        </Link>
                    ...
                    {hotNews.map((news) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-0.5 overflow-hidden flex-1">
                                ...
                                <h3 className="text-[3px] md:text-[10px] font-black text-white uppercase italic leading-snug line-clamp-2">{news.title}</h3>
                            </div>
                        </Link>
                    ))}
                </div>
