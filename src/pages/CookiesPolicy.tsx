                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-white/5 border border-white/5 rounded-xl p-6">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-xl font-semibold text-white">Marketing & Advertising Cookies</h3>
                                </div>
                                <p className="leading-relaxed mb-2">
                                ...
                                <div className="mt-3 text-sm">
                                    <p className="text-gray-400"><strong className="text-white">Compliance:</strong> These cookies are collected with your explicit consent for users in the EEE, UK, and Switzerland.</p>
                                    <p className="text-gray-400"><strong className="text-white">Examples:</strong> Google AdSense, DoubleClick</p>
                                </div>
                            </div>
                        </div>
                    </motion.section>
                ...
                >
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white/5 border border-white/5 rounded-xl p-6">
                            <div className="flex items-center gap-3 mb-3">
                                <Target className="w-5 h-5 text-neon-red" />
                                <h3 className="text-xl font-semibold text-white">Cookies Publicitaires & Marketing</h3>
                            </div>
                            <p className="leading-relaxed mb-2">
                                Ces cookies sont utilisés pour diffuser des publicités plus pertinentes pour vous et vos centres d'intérêt. Ils sont également utilisés pour limiter le nombre de fois que vous voyez une publicité et pour aider à mesurer l'efficacité des campagnes publicitaires.
                            </p>
                            <div className="mt-3 text-sm">
                                <p className="text-gray-400"><strong className="text-white">Conformité :</strong> Ces cookies sont collectés avec votre consentement explicite conformément au RGPD pour les utilisateurs de l'EEE, du Royaume-Uni et de la Suisse.</p>
                                <p className="text-gray-400"><strong className="text-white">Exemples :</strong> Google AdSense, DoubleClick</p>
                            </div>
                        </div>
                    </div>
                </motion.section>
