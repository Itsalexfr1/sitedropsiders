                            ...
                            >
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <span className="text-[9px] text-gray-500 font-bold uppercase tracking-widest mt-0.5">
                                        Je certifie que <span className="font-black" style={{ color: getEditorColor(((editorsData as any[]).find(e => e.name === author)?.username || author).toLowerCase()) }}>{author}</span> est bien l'auteur de ce contenu
                                    </span>
                                </div>
                            </div>
                        </div>
