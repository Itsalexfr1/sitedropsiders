...
<div class="music-top-item-premium mb-12 last:mb-0">
    ...
    return (
        <div className="min-h-screen bg-dark-bg py-20 md:py-32 px-4 md:px-6">
                    ...
                    <div className="flex-1 flex items-center justify-end gap-3 md:gap-4">
                        {isEditing && (
                            <button
                                ...
                                className={`flex items-center gap-2 px-4 md:px-6 py-2.5 rounded-2xl font-black uppercase tracking-widest text-[8px] md:text-[10px] transition-all shadow-lg ${status === 'loading'
                        ...
                        <button
                            ...
                            className={`flex items-center gap-2 px-4 md:px-6 py-2.5 rounded-2xl font-black uppercase tracking-widest text-[8px] md:text-[10px] transition-all border ${isFeatured
                                ? 'bg-yellow-500/20 border-yellow-500 text-yellow-500 shadow-[0_0_20px_rgba(234,179,8,0.2)]'
                                : 'bg-white/5 border-white/10 text-gray-500 hover:text-white hover:border-white/20'
                                }`}
                        >
                            <Star className={`w-3 md:w-4 h-3 md:h-4 ${isFeatured ? 'fill-current' : ''}`} />
