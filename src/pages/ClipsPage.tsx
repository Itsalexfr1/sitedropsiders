        ...
        <div className="min-h-screen bg-dark-bg pt-20">
            <div className="max-w-[1400px] mx-auto px-4 md:px-12 xl:px-16 2xl:px-24 py-12 border-b border-white/10 mb-8 mt-12">
                <h1 className="text-4xl md:text-5xl lg:text-7xl font-black text-white uppercase italic tracking-tighter mb-4">
                    Clips <span className="text-neon-sky">& VOD</span>
                </h1>
            ...
            <div className="max-w-[1400px] mx-auto px-4 md:px-12 xl:px-16 2xl:px-24 pb-12">
                {isLoading ? (
                    <div className="text-center py-32 flex flex-col items-center justify-center space-y-4">
                        <div className="w-12 h-12 border-4 border-neon-sky border-t-transparent rounded-full animate-spin" />
                    ...
                    <div className="text-center py-32 flex flex-col items-center justify-center space-y-4 bg-white/[0.02] border border-white/5 rounded-[3rem]">
                        <div className="relative group">
                            <div className="absolute inset-0 bg-neon-sky blur-2xl opacity-10" />
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <div className="flex items-start justify-between mb-6">
                                        <div className="p-3 bg-neon-sky/10 border border-neon-sky/20 rounded-2xl text-neon-sky shadow-[0_0_15px_rgba(188,19,254,0.1)]">
                                    ...
                                    <div className="flex items-center gap-4 mb-8">
                                        ...
                                        <p className="text-[10px] text-neon-sky font-black uppercase tracking-widest">
                                            @{clip.creator || 'ANONYME'}
                                        </p>
                                    </div>

                                    <div className="flex gap-3">
                                        <button className="flex-1 flex items-center justify-center gap-2 py-3.5 bg-neon-sky rounded-2xl text-[10px] font-black uppercase text-white hover:opacity-90 transition-all shadow-[0_0_20px_rgba(188,19,254,0.3)]">
