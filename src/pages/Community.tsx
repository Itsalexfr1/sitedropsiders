...
const DJ_POOL = [
    ...
    { id: 'dg', name: 'David Guetta', price: 850000, genre: 'Mainstage', popularity: 99 },
    { id: 'tiesto', name: 'Tiësto', price: 750000, genre: 'Big Room', popularity: 99 },
    { id: 'mh', name: 'Martin Garrix', price: 800000, genre: 'Progressive House', popularity: 99 },
    { id: 'av', name: 'Armin van Buuren', price: 450000, genre: 'Trance', popularity: 98 },
    { id: 'alok', name: 'Alok', price: 400000, genre: 'Slap House', popularity: 97 },
    { id: 'tt', name: 'Timmy Trumpet', price: 350000, genre: 'Psytrance', popularity: 96 },
    { id: 'aj', name: 'Afrojack', price: 320000, genre: 'Dutch House', popularity: 95 },
    { id: 'h', name: 'Hardwell', price: 450000, genre: 'Big Room Techno', popularity: 98 },
    { id: 'sa', name: 'Steve Aoki', price: 380000, genre: 'Electro House', popularity: 97 },
    { id: 'aw', name: 'Alan Walker', price: 420000, genre: 'Future Bass', popularity: 98 },
    { id: 'k', name: 'KSHMR', price: 280000, genre: 'Mainstage', popularity: 94 },
    { id: 'dd', name: 'Don Diablo', price: 250000, genre: 'Future House', popularity: 93 },
    { id: 'r3', name: 'R3HAB', price: 220000, genre: 'Dance', popularity: 94 },
    { id: 'lf', name: 'Lost Frequencies', price: 320000, genre: 'Deep House', popularity: 96 },
    { id: 'ww', name: 'W&W', price: 280000, genre: 'Big Room', popularity: 95 },
    { id: 'ch', name: 'Calvin Harris', price: 1250000, genre: 'Dance Pop', popularity: 99 },
    { id: 'nr', name: 'Nicky Romero', price: 180000, genre: 'Progressive', popularity: 94 },
    { id: 'oh', name: 'Oliver Heldens', price: 260000, genre: 'Future House', popularity: 96 },
    { id: 'ds', name: 'DJ Snake', price: 550000, genre: 'Trap', popularity: 98 },
    { id: 'ms', name: 'Marshmello', price: 650000, genre: 'Future Bass', popularity: 99 },
    { id: 'alesso', name: 'Alesso', price: 420000, genre: 'Progressive House', popularity: 98 },
    { id: 'ep', name: 'Eric Prydz', price: 550000, genre: 'Progressive House', popularity: 99 },
    { id: 'z', name: 'Zedd', price: 380000, genre: 'Electro Pop', popularity: 97 },
    { id: 'dvlm', name: 'Dimitri Vegas & Like Mike', price: 480000, genre: 'Big Room', popularity: 98 },
    { id: 'shm', name: 'Swedish House Mafia', price: 1100000, genre: 'House', popularity: 99 },

    // --- TECH HOUSE / HOUSE / MINIMAL ---
    { id: 'js', name: 'John Summit', price: 350000, genre: 'Tech House', popularity: 98 },
    { id: 'm', name: 'Mochakk', price: 280000, genre: 'Tech House', popularity: 97 },
    { id: 'bb', name: 'Michael Bibi', price: 320000, genre: 'Tech House', popularity: 96 },
    { id: 'fg', name: 'Fisher', price: 550000, genre: 'Tech House', popularity: 99 },
    { id: 'pg', name: 'Peggy Gou', price: 450000, genre: 'House', popularity: 98 },
    { id: 'fa', name: 'Fred again..', price: 950000, genre: 'Future Garage', popularity: 99 },
    { id: 'ca', name: 'Cassian', price: 140000, genre: 'Melodic Techno', popularity: 94 },
    { id: 'p', name: 'Pawsa', price: 180000, genre: 'Minimal House', popularity: 93 },
    { id: 'an', name: 'Anotr', price: 190000, genre: 'No Art', popularity: 95 },
    { id: 'cl', name: 'Chris Lake', price: 280000, genre: 'Tech House', popularity: 97 },
    { id: 'mp', name: 'Mau P', price: 220000, genre: 'Tech House', popularity: 97 },
    { id: 'jj', name: 'Jamie Jones', price: 240000, genre: 'House', popularity: 96 },
