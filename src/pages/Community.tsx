        ...
        <>
                    ...
                    >
                        <div>
                            ...
                            <h1 className="text-4xl md:text-6xl font-display font-black text-white mb-6 uppercase italic tracking-tighter leading-none">
                                LA <span className="text-neon-cyan drop-shadow-[0_0_20px_rgba(0,240,255,0.5)]">COMMUNAUTÉ</span>
                            </h1>
                        ...
                        <motion.button
                            ...
                            className="group relative px-8 py-4 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-[0_0_30px_rgba(255,255,255,0.05)] hover:bg-neon-cyan hover:text-white transition-all duration-500 overflow-hidden mx-auto sm:mx-0"
                        >
                            <span className="relative z-10 flex items-center gap-4">
                                Partager Album
                                <div className="p-2 bg-black text-white group-hover:bg-white group-hover:text-neon-cyan rounded-lg transition-colors">
                                ...
                                <div className="flex flex-col items-center gap-8">
                                    ...
                                    <div className="text-center space-y-2">
                                        <h2 className="text-4xl md:text-6xl font-display font-black uppercase italic tracking-tighter">
                                            ESPACE <span className="text-neon-cyan">CONCOURS</span>
                                        </h2>
                            ...
                            >
                                <div className="bg-white/5 border border-white/10 rounded-[4rem] p-8 md:p-16 backdrop-blur-3xl space-y-12">
                                    <div className="text-center space-y-4">
                                        <div className="inline-flex p-4 bg-neon-cyan/10 rounded-3xl mb-4">
                                        ...
                                        <h2 className="text-3xl md:text-5xl font-display font-black uppercase italic tracking-tighter">
                                            PARTAGEZ VOS <span className="text-neon-cyan">SOUVENIRS</span>
                                        </h2>
                                    ...
                                    {!uploadSuccess ? (
                                        <div className="space-y-8 bg-black/20 p-8 md:p-12 rounded-[3rem] border border-white/5">
                                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                                <div className="space-y-3 relative">
                                                    ...
                                                    <div className="relative group/input">
                                                        <Search className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-white/20 group-focus-within/input:text-neon-cyan transition-colors" />
                                                        <input 
                                                            type="text"
                                                            ...
                                                            className="w-full bg-white/5 border border-white/10 rounded-2xl pl-12 pr-5 py-5 text-xs font-black italic uppercase focus:border-neon-cyan outline-none transition-all placeholder:text-white/10"
                                                        />
                                                ...
                                                <div className="space-y-3">
                                                    ...
                                                    <input 
                                                        ...
                                                        className="w-full bg-white/5 border border-white/10 rounded-2xl p-5 text-xs font-black italic uppercase focus:border-neon-cyan outline-none"
                                                    />
                                                </div>
                                            </div>

                                            <div className="border-2 border-dashed border-white/10 rounded-[2.5rem] p-12 text-center group hover:border-neon-cyan/50 transition-all cursor-pointer bg-white/[0.02]">
                                                <input type="file" className="hidden" id="photo-upload" accept="image/*" multiple />
                                                <label htmlFor="photo-upload" className="cursor-pointer block">
                                                    <Plus className="w-12 h-12 text-white/20 mx-auto mb-4 group-hover:scale-110 group-hover:text-neon-cyan transition-all" />
                                            ...
                                            <button 
                                                ...
                                                className="w-full py-6 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-[0.3em] hover:bg-neon-cyan hover:text-white transition-all duration-500 shadow-xl"
                                            >
                                        ...
                                        {gameState !== 'ONBOARDING' && gameState !== 'RESULTS' && (
                                            <div className="sticky top-0 z-50 py-6 px-10 bg-black/80 backdrop-blur-xl border-b border-white/10 flex flex-col md:flex-row items-center justify-between gap-6 -mx-12 mb-12 shadow-2xl">
                                                ...
                                                <div className="flex-1 max-w-md w-full h-2 bg-white/5 rounded-full overflow-hidden border border-white/5 mx-6">
                                                    <motion.div
                                                        className={twMerge("h-full", remainingBudget < 0 ? "bg-neon-cyan" : "bg-gradient-to-r from-amber-400 to-amber-600")}
                                                ...
                                                <div className="px-6 py-2 bg-white/5 border border-white/10 rounded-xl">
                                                    <span className={twMerge("text-sm font-black italic", remainingBudget < 0 ? "text-neon-cyan animate-pulse" : "text-emerald-400")}>
                                                ...
                                                <div className="lg:col-span-4 space-y-8">
                                                    <div className="sticky top-24 p-10 bg-white/5 backdrop-blur-3xl border border-white/10 rounded-[3rem] shadow-2xl space-y-10">
                                                        ...
                                                        <div className="space-y-4">
                                                            <div className="flex justify-between items-end">
                                                                ...
                                                                <div className="flex flex-col items-end">
                                                                    ...
                                                                    {isPriceRising && <span className="text-[8px] text-neon-cyan font-black uppercase animate-pulse">Alerte : Prix en hausse !</span>}
                                                                </div>
                                                            </div>
                                                            <div className="w-full h-3 bg-white/5 rounded-full overflow-hidden border border-white/5">
                                                                <motion.div
                                                                    className={twMerge("h-full transition-colors duration-500", remainingBudget < 0 ? "bg-neon-cyan" : "bg-amber-400")}
                                                                    animate={{ width: `${Math.min(100, (totalSpent / (budget + sponsorsBonus)) * 100)}%` }}
                                                                />
                                                            </div>
                                                            <div className="flex justify-between">
                                                                <span className="text-[9px] font-bold text-white/20 uppercase">Budget Max: {(budget + sponsorsBonus).toLocaleString()}€</span>
                                                                <span className={twMerge("text-[9px] font-black uppercase", remainingBudget < 0 ? "text-neon-cyan animate-pulse" : "text-emerald-400")}>
                                                        ...
                                                        <button
                                                            ...
                                                            className="w-full py-6 rounded-[1.5rem] bg-white text-black font-black text-[10px] uppercase tracking-[0.3em] disabled:opacity-20 hover:bg-neon-cyan hover:text-white transition-all duration-500 shadow-2xl"
                                                        >
                                                        ...
                                                        <AnimatePresence>
                                                            {activeCrisis && (
                                                                ...
                                                                >
                                                                    ...
                                                                    >
                                                                        <div className="text-center space-y-4">
                                                                            <div className="w-20 h-20 bg-neon-cyan/20 rounded-3xl flex items-center justify-center mx-auto border border-neon-cyan/30">
                                                        ...
                                                        className={twMerge(
                                                            ...
                                                            posterStyle === 'ULTRA' ? "bg-white border-[1px] border-black" :
                                                                posterStyle === 'TOMORROWLAND' ? "bg-[#0a0a0d] border-[16px] border-[#d4af37]" :
                                                                    "bg-black border-[2px] border-neon-cyan shadow-[0_0_80px_rgba(0,240,255,0.2)]"
                                                        )}
                                                    >
                                                        {/* Background Elements */}
                                                        {posterStyle === 'ULTRA' && (
                                                                            ...
                                                                            className={twMerge(
                                                                                ...
                                                                                posterStyle === 'ULTRA' ? (isHeadline ? "text-black font-display" : "text-black/40") :
                                                                                    posterStyle === 'TOMORROWLAND' ? (isHeadline ? "text-[#d4af37]" : "text-white/30") :
                                                                                        (isHeadline ? "text-white drop-shadow-[0_0_10px_rgba(255,255,255,0.5)]" : "text-neon-cyan/50")
                                                                            )}
                                                    ...
                                                    <div className="p-10 bg-white/5 border border-white/10 rounded-[3rem] backdrop-blur-3xl space-y-10">
                                                        ...
                                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                                            ...
                                                            <div className="p-8 bg-white/[0.03] rounded-[2rem] border border-white/5 text-center">
                                                                ...
                                                                <span className={twMerge("text-3xl font-black", profit >= 0 ? "text-emerald-400" : "text-neon-cyan")}>{profit.toLocaleString()}€</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="space-y-6">
                                                            ...
                                                            <div className="flex flex-col sm:flex-row gap-4">
                                                                <button onClick={() => window.print()} className="flex-1 py-6 bg-white text-black rounded-2xl font-black text-[10px] uppercase tracking-widest hover:bg-neon-cyan hover:text-white transition-all">Sauvegarder Affiche</button>
                                                                <button
                                                                    onClick={async () => {
                                                                ...
                                                                archives.map((entry, idx) => (
                                                                    <div key={idx} className="p-6 bg-white/[0.03] border border-white/5 rounded-2xl group hover:bg-white/[0.05] transition-all">
                                                                        ...
                                                                        <div className="flex justify-between items-end">
                                                                            ...
                                                                            <span className={twMerge("text-xs font-black font-mono", entry.profit >= 0 ? "text-emerald-400" : "text-neon-cyan")}>{entry.profit.toLocaleString()}€</span>
                                                                        </div>
                                                                    </div>
                                                                ))
                                                            )}
            ...
            {!isLoggedIn && (
                ...
                >
                    ...
                    >
                        {/* Glows */}
                        <div className="absolute -top-24 -left-24 w-48 h-48 bg-neon-cyan/20 rounded-full blur-[80px] animate-pulse" />
                        <div className="absolute -bottom-24 -right-24 w-48 h-48 bg-neon-fuchsia/20 rounded-full blur-[80px] animate-pulse" />

                        <div className="relative space-y-6">
                            <div className="w-24 h-24 bg-neon-cyan/10 rounded-3xl flex items-center justify-center mx-auto mb-8 border border-neon-cyan/20">
                                <Lock className="w-10 h-10 text-neon-cyan shadow-[0_0_20px_rgba(0,240,255,0.5)]" />
                            </div>
                            
                            <div className="space-y-4">
                                <h2 className="text-3xl md:text-4xl font-display font-black text-white italic uppercase tracking-tighter leading-none">
                                    EXPÉRIENCE <span className="text-neon-cyan">RÉSERVÉE</span>
                                </h2>
                            ...
                            <div className="pt-6 space-y-4">
                                <button
                                    ...
                                    className="w-full py-6 bg-white text-black rounded-2xl font-black text-xs uppercase tracking-[0.3em] hover:bg-neon-cyan hover:text-white transition-all duration-500 shadow-[0_15px_40px_rgba(0,0,0,0.5)]"
                                >
                                    Créer mon compte
                                </button>
                                <button
