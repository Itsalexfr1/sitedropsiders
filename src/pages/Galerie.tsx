                        ...
                        currentAlbums.map((album, index) => (
                            ...
                            >
                                <Link
                                    ...
                                    className="group relative block aspect-video rounded-3xl overflow-hidden bg-black border border-white/10 hover:border-neon-red/50 transition-all duration-500 shadow-2xl"
                                >
                                    <motion.div
                                        whileHover={{ scale: 1.05 }}
                                        onMouseEnter={playHoverSound}
