                        ...
                        <div className="relative flex-1 w-full md:max-w-md">
                            ...
                            {searchTerm && (
                                <button
                                    ...
                                    className="absolute right-3 top-1/2 -translate-y-1/2 p-1 hover:bg-white/10 rounded-full transition-colors text-gray-400 hover:text-white z-10"
                                >
                                    <X className="w-4 h-4" />
                                </button>
                            )}
                                    ...
                                    {filteredSubscribers.map((subscriber, index) => (
                                        ...
                                        >
                                            ...
                                            <td className="p-4 text-right">
                                                <button
                                                    onClick={() => setDeleteTarget(subscriber.email)}
