...
import { UserPlus, Trash2, User, Lock, ArrowLeft, Loader2, Save, X, Pencil } from 'lucide-react';
...
const AVAILABLE_PERMISSIONS = [
    ...
    { id: 'mail', label: 'Messagerie', description: 'Accès aux emails Dropsiders' }
];
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 md:mb-12">
                    <div className="flex items-center gap-4 md:gap-6">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 mt-2 text-sm md:text-base">Gérez les accès de l'équipe</p>
                        </div>
                    </div>
